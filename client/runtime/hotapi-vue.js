define('runtime/hotapi-vue.js',['node/vue.js'], function () {
  ...
  (function (window) {
    ...
    result.createRecord = (id, options) => {
      let Ctor = null
    ...
    result.rerender = tryWrap((id, options) => {
      const record = map[id]
      if (!options) {
    ...
    result.reload = tryWrap((id, options) => {
      const record = map[id]
      if (options) {
        if (typeof options === 'function') {
          options = options.options
